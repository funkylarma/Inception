 ...
 * Slug: inception/general-hero-three-columns
 * Categories: hero
 * Viewport Width: 1280
 */
?>
...
<h2 class="has-text-align-center has-x-large-font-size" id="image-heading-text-button-1"><?php echo esc_html__( 'Image, heading, text, button.', 'inception' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link no-border-radius"><?php echo esc_html__( 'Learn More', 'inception' ); ?></a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
</div>
