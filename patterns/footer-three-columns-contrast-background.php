 ...
 * Slug: inception/footer-three-columns-contrast-background
 * Categories: footer
...
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'Privacy Policy', 'inception' ); ?></a> · <a href="#"><?php echo esc_html__( 'Terms of Service', 'inception' ); ?></a> · <a href="#"><?php echo esc_html__( 'Contact Us', 'inception' ); ?></a></p>
<!-- /wp:paragraph -->
