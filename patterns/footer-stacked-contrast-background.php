 ...
 * Slug: inception/footer-stacked-contrast-background
 * Categories: footer
...
<h2 class="has-text-align-center has-max-48-font-size" id="let-s-connect" style="font-style:normal;font-weight:400;margin-bottom:20px"><?php echo esc_html__( 'Let’s Connect', 'inception' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-button is-style-outline-base"><a class="wp-block-button__link no-border-radius" href="#"><?php echo esc_html__( 'Get in Touch', 'inception' ); ?> →</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
<!-- wp:paragraph {"align":"center","fontSize":"small"} -->
<p class="has-text-align-center has-small-font-size">© <?php echo esc_html( gmdate( 'Y' ) ); ?> All rights reserved. · <a href="#"><?php echo esc_html__( 'Contact Us', 'inception' ); ?></a></p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
