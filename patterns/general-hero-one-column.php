 ...
 * Slug: inception/general-hero-one-column
 * Categories: hero
 */
?>
...
<div class="wp-block-button"><a class="wp-block-button__link no-border-radius wp-element-button"><?php echo esc_html__( 'Get Started', 'inception' ); ?></a></div>
<!-- /wp:button -->
